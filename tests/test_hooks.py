...
class HooksTest(unittest.TestCase):
    def test_build_update_command_uses_python_module_entrypoint(self) -> None:
        ...
        self.assertIn(
            "PYTHONPATH=/tmp/skills-manager /usr/bin/python3 -m internal.hook_runner --cli codex",
            command,
        )
    ...
    def test_build_update_command_without_repo_path_uses_python_module_entrypoint(self) -> None:
        ...
        self.assertIn("/usr/bin/python3 -m internal.hook_runner --cli codex", command)
    ...
    def test_build_update_command_can_include_force(self) -> None:
        ...
        self.assertIn("/usr/bin/python3 -m internal.hook_runner --cli codex --force", command)
    ...
    def test_initialize_cli_hook_writes_config_defaults(self) -> None:
        ...
        self.assertEqual(
            ...
            f"PYTHONPATH={repo_path} /usr/bin/python3 -m internal.hook_runner --cli codex",
        )
